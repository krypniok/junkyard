...
Function LibraryFunctions[] = {
    ...
    {"glEnd", {}, 0, (void (*)())glEnd},
    {"printf", {PARAM_TYPE_STRING, PARAM_TYPE_STRING}, 2, (void (*)())printf},
    {"funcTest", {PARAM_TYPE_FLOAT, PARAM_TYPE_FLOAT, PARAM_TYPE_FLOAT}, 3, (void (*)())funcTest},
